...
class Workbench(tk.Tk):
    ...
    def add_command(self, command_id, menu_name, command_label, handler,
        ...
        Returns:
            None
        """     
        command_label = translate(command_label) # 翻译接口
...
def translate(label):
    return _translate_map.get(label) or label