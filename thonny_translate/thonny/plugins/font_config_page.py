...
class FontConfigurationPage(ConfigurationPage):
    ...
    def __init__(self, master):
        ...
        ttk.Label(self, text="编辑器字体").grid(row=0, column=0, sticky="w")
        ...
        ttk.Label(self, text="字体大小").grid(row=0, column=1, sticky="w")
        ...
        ttk.Label(self, text="预览").grid(row=2, column=0, sticky="w", pady=(10,0))
...
def load_plugin():
    get_workbench().add_configuration_page("字体", FontConfigurationPage)