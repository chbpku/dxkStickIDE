...
class InterpreterConfigurationPage(ConfigurationPage):
    ...
    def __init__(self, master):
        ...
        entry_label = ttk.Label(self, text="想用哪个Python解释器运行代码?")
        ...
        another_label = ttk.Label(self, text="列表中不包含你要用的解释器?")
...
def load_plugin():
    get_workbench().add_configuration_page("解释器", InterpreterConfigurationPage)
